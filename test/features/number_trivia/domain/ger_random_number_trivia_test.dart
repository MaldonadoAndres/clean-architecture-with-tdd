...
import 'package:clean_architecture_with_tdd/features/number_trivia/domain/usecases/get_random_number_trivia.dart';
...
void main() {
  ...
  test('Should get trivia from random number', () async {
    // arrange
